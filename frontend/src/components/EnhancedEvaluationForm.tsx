        ...
        <CardContent>
                ...
                <Paper elevation={1} sx={{ p: 3, height: '100%' }}>
                  <Box sx={{ mb: 2 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                      ...
                      <Chip 
                        label={(preferences[key as keyof EnhancedEvaluationPreferences] as number)?.toFixed(1)} 
          ...
          <Box sx={{ mt: 4, p: 3, backgroundColor: '#f8f9fa', borderRadius: 2 }}>
            ...
            <Typography variant="body2" paragraph>
              この拡張版システムは、<strong>適応型ファジィ決定木（AFDT）</strong>と<strong>研究分野興味度分析</strong>を組み合わせた
              高度なアルゴリズムにより、あなたの希望と各研究室の特徴を多角的に分析し、最適なマッチングを提供します。
            </Typography>
